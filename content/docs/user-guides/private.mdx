...
[Anleitung für Zählerfreunde Geschäftskunden](./business.mdx) 
...
Admins können die Ansicht „Verbrauchsmuster" aktivieren, welche den Verbrauch als Heatmap visualisiert. Diese Funktion steht ausschließlich für B2B-Kunden zur Verfügung.
...
Das Thema „Optimieren“ beschäftigt sich mit Energiemanagement und Logiken.
