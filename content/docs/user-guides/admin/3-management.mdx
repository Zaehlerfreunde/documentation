...
-   Möglichkeit weitere Mitarbeiter als Admin hinzuzufügen. Diese Mitarbeiter haben dann das Recht auf den Admin-Bereich zuzugreifen und können alle hier beschriebenen Funktionen sehen und bearbeiten. Admins können auch direkt als Admin eingeladen werden, ohne zuvor als regulärer Nutzer angelegt zu sein.
-  Ab sofort können Admins direkt gezielt als Admins eingeladen werden.
-   ACHTUNG! Bitte passen Sie auf, dass hier nicht aus Versehen Kunden hinzugefügt werden oder andere unbefugte Personen.
  
  <img alt="image" src="https://github.com/user-attachments/assets/c70c9cbc-3412-43f0-93db-20ec550aa8f1" />
...
[Zählerfreunde API Integration](../../integrations/api/index.mdx)
