...
-   “Verbrauchsmuster-Diagramm”:

Das Verbrauchsmuster-Diagramm stellt den Energieverbrauch als Heatmap dar. Die Farben zeigen auf einen Blick, zu welchen Tageszeiten und an welchen Tagen besonders viel oder wenig Energie verbraucht wird. Dadurch lassen sich typische Verbrauchsmuster, wiederkehrende Lastspitzen und ungewöhnliche Abweichungen schnell erkennen.
...
[Anleitung für Zählerfreunde Privatkunden](../private.mdx)
